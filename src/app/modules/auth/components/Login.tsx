...
export function Login() {
  ...
  return (
    <form
      className='form w-100 shadow-sm p-10'
    ...
    >
      ...
      <div className='text-center mb-11'>
        <div>
          <img src={LOGO_IMG_URL} alt='EVERGLOW' className='w-25' />
        </div>
        <p className='fs-lg-1 mt-3 mb-3'>Admin Sign In</p>
      </div>
      {/* begin::Heading */}
      {/* {formik.status ? (
      ...
      {/* end::Form group */}
      {/* begin::Wrapper */}
      <div className='d-flex mt-4 justify-content-center flex-wrap gap-3 fs-base fw-semibold mb-8'>
        <div />
        {/* begin::Link */}
